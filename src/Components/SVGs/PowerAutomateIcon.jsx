const PowerAutomateIcon = () => (
  <svg width="30" height="25" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
  <filter id="filter0_f">
  ...
  <path d="M63 10.4L-5 86.4H63L97 48.4L63 10.4Z" fill="white" fill-opacity="0.24"/>
  </g>
  <g filter="url(#filter1_f)">
  <path d="M63 12L-5 88H63L97 50L63 12Z" fill="white" fill-opacity="0.32"/>
  </g>
