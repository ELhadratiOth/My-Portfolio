...
const services = [
  {
    ...
    description:
      'I design and implement robust data pipelines and architectures that ensure seamless data flow and accessibility. By employing advanced ETL/ELT techniques and leveraging cloud platforms like AWS, I create scalable, secure, and efficient data solutions tailored to your business needs.',
